...
HF_CACHE_DIR = "/dtu/blackhole/10/169104/data/hf_cache"
...
class ObjectPlacementHeatmapModel(nn.Module):
    def __init__(
        ...
        self.dino = AutoModel.from_pretrained(dino_name, cache_dir=HF_CACHE_DIR)
        ...
        self.depth_processor = AutoImageProcessor.from_pretrained(depth_name, cache_dir=HF_CACHE_DIR)
        self.depth_model = AutoModelForDepthEstimation.from_pretrained(depth_name, cache_dir=HF_CACHE_DIR)
        ...
        text_dim = self.text_encoder.config.text_config.hidden_size
